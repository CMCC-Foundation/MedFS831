...
! 1-file name 2-Date
      ...
      integer :: tmeid, spdid,spdid2, spdid3,dateb, i, jjj
      real rval
...
!                             endif
      ...
      call handle_err(ist)
      ist=nf_def_var(ncio, 'flag', nf_short, 1,dimen, spdid3)
      call handle_err(ist)
      ...
      call handle_err(ist)
      ist=nf_put_var_real(ncio, spdid3, flagb)
      call handle_err(ist)
